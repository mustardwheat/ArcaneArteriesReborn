...
public class AAItems {
    public static final Item mana_slate = new AAItem().setRegistryName("mana_slate").setTranslationKey("mana_slate").setCreativeTab(ArcaneArteriesReborn.creativeTab);
    public static final Item thaumic_slate = new AAItem().setRegistryName("thaumic_slate").setTranslationKey("thaumic_slate").setCreativeTab(ArcaneArteriesReborn.creativeTab);
